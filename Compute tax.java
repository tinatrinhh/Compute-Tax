...
public class Q4 {
	public static void main(String[] args) {
		...
		// Show the user the options of filling status
		System.out.print("(0 - single filler, 1 - married jointly or qualifying widow(er), 2 - married separately, 3 - head of household");
	
		// Ask the user to enter filing status
	    ...
	    if (status == 0) { // Compute tax for single filers
	        ...
	        // 33% marginal tax rate 
	    	  ...
	    	  // 28% tax rate 
	    		  ...
	    		  tax = 8350 * .10 + (33950 - 8350)*0.15 + 
	    		  (68525 - 33950)*0.25 + (income - 68525)*.28; 
	    	  // 33% tax rate 
	    	  else if (income <= 186475)
	    		  tax = 8350 * .10 + (33950 - 8350)*0.15 + 
	    		  (68525 - 33950)*0.25 + (104425 - 68525)*.28 + (income - 104425); 
	    	  else 
	    		  tax = 8350 * .10 + (33950 - 8350)*0.15 + 
	    		  (68525 - 33950)*0.25 + (104425 - 68525)*.28 + (186475-104425)*0.33 + (income - 186475)*0.35; 
	      }
